...
```{r echo=FALSE, fig.alt="running commands using the Exec tab in Docker Descktop"}
ottrpal::include_slide("https://docs.google.com/presentation/d/1_5FJ6SYA2t1F7BX5-Vvzi2LHEVUmXS4eFvousSqcl9w/edit?slide=id.g2ebd8828116_0_1035#slide=id.g2ebd8828116_0_1035")
```
