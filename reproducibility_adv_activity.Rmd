...
<input type="checkbox"> To see what images we have we can run `docker image ls` and we should see `jhudsl/reproducible-r` show up now.
...
## Step 2: Take a look at your GitHub Action run!
...
**What is this being run on if you were to guess based on these logs?**    
