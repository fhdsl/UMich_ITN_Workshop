...
As it is dependent on the installation of `ggplot2`, it uses a lot `gg` styled syntax, including one of the key functions `ggsurvplot()`, which creates Kaplan-Meier survival curves with extensive customization options. 
