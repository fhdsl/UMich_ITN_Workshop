...
<summary>Using the command-line: Data normalization using spatialGE</summary>

```{r eval=F}
# Perform data normalization using SCTransform
# First allow higher memory allocation
options(future.globals.maxSize=1200000000000)

# Then, perform data transformation
