...
<div class = "link_button"><a href="https://docs.google.com/presentation/d/1hrlVq_DZVqPKeBWcSaVq4nP9XSoAS2qalZbP9rukYpk/edit?usp=sharing" target="_blank"> Slides Link</a></div>

<div class = "slido_button"><a href="https://app.sli.do/event/jUV9ycuttFZ9fZx8e9maGi" target="_blank"> Discussion Link </a></div>
...
- There are additional files to practice using the `spatialGE` package on [Posit Cloud](https://posit.cloud/) at the link we sent you
<!--
### Note from Oscar:
