...
install.packages(c("rbibutils", "Rdpack", "reformulas", "sqldf", "survival"), repos='https://cloud.r-project.org')
install.packages("nloptr", repos='https://cloud.r-project.org')
install.packges("lme4",repos='https://cloud.r-project.org')
install.packages("pbkrtest",repos='https://cloud.r-project.org')
install.packages("car", repos='https://cloud.r-project.org')
instal.packages("rstatix", repos='https://cloud.r-project.org')
