...
<input type="checkbox"> [Download the relevant datasets](https://datasets.genepattern.org/?prefix=data/workshops/240411-PSTP/)
  - <input type="checkbox"> Download `BRCA_HUGO_symbols.preprocessed.cls`
  - <input type="checkbox"> Download `BRCA_HUGO_symbols.preprocessed.gct`
...
<input type="checkbo"> Select the `cls` file (`BRCA_HUGO_symbols.preprocessed.cls`) for the "cls file*" option.
