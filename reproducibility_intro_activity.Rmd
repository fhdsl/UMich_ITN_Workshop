...
<input type="checkbox"> Go to phind https://www.phind.com/search in your browser
...
<input type="checkbox"> Click one of the plus signs to the left of one of your changes to leave a comment. Type something and then click `Add single comment`. Nice, you added a comment!
...
<input type="checkbox"> You should be prompted to `Pull origin` click this button.  <input type="checkbox"> Click the History tab to see your changes over time. Note the most recent are at the top.
...
<input type="checkbox"> If no failing checkes, Click the 3 dots at the end of the line that says `Render R Example / render-notebooks (pull_request)`. Click `View Details` 
